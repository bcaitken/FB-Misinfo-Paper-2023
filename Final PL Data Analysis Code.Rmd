...
library(ggpubr)
ggarrange(us.plot1, pl.plot1, ncol  =2)

("Contextualized Media Coverage" = "tr_all1", "De-Contextualized Media Coverage" = "tr_all2", "Accountability Fact Checking" = "tr_all3", "Correctability Fact Checking" = "tr_all4", "Bias News Media Literacy" = "tr_all5", "Fake News Media Literacy" = "tr_all6")
...
plot.means.skept.pl <-ggplot(data = subset(pl.boxplot.data, !is.na(tr_all)), aes(x = tr_all, y = mean_skept)) +
geom_bar(stat="identity", fill = "lightblue")+
xlab("Treatment Group") +
ylab("Skepticism Score") +
  ylim(0,3.5)+
  geom_errorbar(aes(ymin=mean_skept-skept_sd, ymax=mean_skept+skept_sd), width=.2,
                 position=position_dodge(.9))+
ggtitle("Distribution of Skepticism Scores by Treatment Group in Poland") +
scale_x_discrete(labels = c("Control", "Contextualized \n Media Coverage", "De-Contextualized \nMedia Coverage", "Accountability\n Fact Checking", "Correctability \nFact Checking", "Bias News\n Media Literacy", "Fake News \nMedia Literacy"))

plot.means.misp.pl <-ggplot(data = subset(pl.boxplot.data, !is.na(tr_all)), aes(x = tr_all, y = mean_misp)) +
geom_bar(stat="identity", fill = "lightgreen")+
xlab("Treatment Group") +
ylab("Misperception Score") +
  ylim(0,3.5)+
  geom_errorbar(aes(ymin=mean_misp-misp_sd, ymax=mean_misp+misp_sd), width=.2,
                 position=position_dodge(.9))+
