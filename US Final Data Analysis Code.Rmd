...
ggarrange(us.plot4, us.plot4.mc, ncol  =2)
 ...
 c("Contextualized Media Coverage" = "tr_all1", "De-Contextualized Media Coverage" = "tr_all2", "Accountability Fact Checking" = "tr_all3", "Correctability Fact Checking" = "tr_all4", "Bias News Media Literacy" = "tr_all5", "Fake News Media Literacy" = "tr_all6")
...
plot.means.skept <-ggplot(data = subset(us.boxplot.data, !is.na(tr_all)), aes(x = tr_all, y = mean_skept)) +
...
plot.means.misp <-ggplot(data = subset(us.boxplot.data, !is.na(tr_all)), aes(x = tr_all, y = mean_misp)) +
